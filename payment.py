...
quantity = st.number_input(
	"How many units do you require?", min_value=1, max_value=10, step=1
)
...
payment_method = st.selectbox(
	"Please select payment method", ["Credit Card", "Debit Card", "UPI"]
)

if payment_method == "Credit Card":
	card_details = st.text_input(
		"Enter your credit card details", max_chars=19, placeholder="1111111111111111"
	)
	...
	upi_number = st.text_input(
		"Enter your UPI number", placeholder="user@icici", max_chars=50
	)
	if upi_number:
